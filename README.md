...
<div align="center">
  ...
  <img src="./banner.svg" width="100%" alt="Mihir Govind Cyberpunk Banner" />
...
<div align="center">
  <!-- Trophies Section -->
  <img src="https://github-profile-trophy.vercel.app/?username=mihir000777&theme=cyberpunk&column=4&margin-w=15&margin-h=15&no-bg=true" alt="GitHub Trophies" />
  ...
  <table width="100%" style="border-collapse: collapse; border: none; background: transparent;">
    <tr style="border: none; background: transparent;">
      <td width="50%" align="center" style="border: none; padding: 5px;">
        <img src="https://github-readme-stats.vercel.app/api?username=mihir000777&show_icons=true&theme=tokyonight&bg_color=05050a&border_color=06b6d4&title_color=06b6d4&text_color=ffffff&icon_color=8b5cf6" alt="GitHub Stats" width="100%"/>
      </td>
      <td width="50%" align="center" style="border: none; padding: 5px;">
        <img src="https://github-readme-streak-stats.herokuapp.com/?user=mihir000777&theme=tokyonight&background=05050a&border=8b5cf6&stroke=8b5cf6&ring=06b6d4&fire=06b6d4&currPlay=06b6d4" alt="GitHub Streak" width="100%"/>
      </td>
    </tr>
  </table>
...
<table width="100%" style="border-collapse: collapse; border: none; background: transparent;">
  <tr style="border: none; background: transparent;">
    <td width="50%" style="border: none; padding: 0 10px 0 0;">
      <div style="background-color: #05050a; border: 1.5px solid #8b5cf6; border-radius: 8px; padding: 15px; min-height: 90px;">
        <h5 style="color: #8b5cf6; margin: 0 0 5px 0; font-family: monospace; font-size: 12px;">💭 QUOTE</h5>
        <p style="font-family: 'Georgia', serif; font-style: italic; font-size: 13px; color: #cbd5e1; margin: 0; line-height: 1.4;">
    ...
    <td width="50%" style="border: none; padding: 0 0 0 10px;">
      <div style="background-color: #05050a; border: 1.5px solid #06b6d4; border-radius: 8px; padding: 15px; min-height: 90px;">
        <h5 style="color: #06b6d4; margin: 0 0 5px 0; font-family: monospace; font-size: 12px;">🤖 JOKE</h5>
        <p style="font-family: monospace; font-size: 11px; color: #cbd5e1; margin: 0; line-height: 1.4;">
    ...
    <tr style="border: none; background: transparent;">
      <td style="border: none; padding: 0;">
        <div style="background: linear-gradient(135deg, #06b6d4 0%, #8b5cf6 50%, #d946ef 100%); padding: 1px; border-radius: 30px; box-shadow: 0 0 15px rgba(139, 92, 246, 0.3);">
          <div style="background: #030308; border-radius: 29px; padding: 10px 25px; display: flex; align-items: center; gap: 15px; color: #e2e8f0; font-family: monospace; font-size: 11px; font-weight: bold;">
